  # Enable Powerlevel1k instant prompt. Should stay close to the top of ~/.zshrc.
  # Initialization code that may require console input (password prompts, [y/n]
  # confirmations, etc.) must go above this block; everything else may go below.
  if [[ -r "${XDG_CACHE_HOME:-$HOME/.cache}/p1k-instant-prompt-${(%):-%n}.zsh" ]]; then
  ...
  #added to use conda
  export PATH="/home/leonardo/miniconda3/bin:$PATH"

  #added path to go installation
...
#the next lines start ssh-agent on login and stop it on logout
...
#end of ssh-agent automatization code
